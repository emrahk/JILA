pro getoirdata_gx02, oirinfo, name, year
...
; LOGS
;
; Adding flux for possible future use
;
...
IF cdata[0] NE -1 THEN BEGIN
   ...
   oirinfo.flux[0,0:nod-1]=SJ[dt]*1000. ;to convert to mJy
...
IF cdata[0] NE -1 THEN BEGIN
   ...
   oirinfo.flux[0,i*nod:(i+1)*nod-1]=SH[dt]*1000. ;mJY
...
IF cdata[0] NE -1 THEN BEGIN
   ...
   oirinfo.flux[0,i*nod:(i+1)*nod-1]=SI[dt]*1000. ;mJy
...
IF cdata[0] NE -1 THEN BEGIN
   ...
   oirinfo.flux[0,i*nod:(i+1)*nod-1]=SV[dt]*1000. ;mJy
