pro plotall_ind, inpstr, ps=ps, namef=fname, onlycert=onlycert, $
noerr=noerr,zpit=zpit, nxr=uxr, nyr=uyr, inc1543=inc1543, inc1752=inc1752,$
inc1720=inc1720, li=li, hi=hi, si=si, ni=ni, bw=bw

IF NOT keyword_set(ps) THEN ps=0
If NOT keyword_set(bw) THEN bw=0

IF NOT keyword_set(fname) THEN BEGIN
   IF bw THEN fname='f6_bw.eps' ELSE fname='f6.eps'
ENDIF
...
plotone_ind, inpstr, 0, yr=yr, /usecol,/opl
...
plotone_ind, inpstr, 1, yr=yr, /usecol,/opl

yp=yp-0.05
oplot,[xp,xp],[yp,yp], psym=8, col=colcode[2]
xyouts,xp+2.,yp-0.01,'GX 339-4, 2005'

plotone_ind, inpstr, 2, yr=yr, /usecol,/opl

yp=yp-0.05
oplot,[xp,xp],[yp,yp], psym=8, col=colcode[2]
xyouts,xp+2.,yp-0.01,'GX 339-4, 2007'

plotone_ind, inpstr, 3, yr=yr, /usecol,/opl,/pcaonly

yp=yp-0.05
oplot,[xp,xp],[yp,yp], psym=8, col=colcode[2]
xyouts,xp+2.,yp-0.01,'GX 339-4, 2011'

plotone_ind, inpstr, 4, yr=yr, /usecol,/opl

yp=yp-0.05
oplot,[xp,xp],[yp,yp], psym=8, col=colcode[2]
xyouts,xp+2.,yp-0.01,'4U 1543-47'

plotone_ind, inpstr, 5, yr=yr, /usecol,/opl
...
IF inc1752 THEN BEGIN
   ...
   plotone_ind, inpstr, 6, yr=yr, /usecol,/opl,/pcaonly
...
plotone_ind, inpstr, 7, yr=yr, /usecol,/opl
...
IF inc1720 THEN BEGIN
   ...
   plotone_ind, inpstr, 8, yr=yr, /usecol,/opl
